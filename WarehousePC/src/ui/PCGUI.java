...
// inactiveJobsPanel = new JPanel();
// {
// inactiveJobsPanel.setBorder(BorderFactory.createTitledBorder("Inactive
// Jobs"));
// inactiveJobsPanel.setPreferredSize(new Dimension(250, 260));
// inactiveJobsPanel.setLayout(new BoxLayout(inactiveJobsPanel,
// BoxLayout.Y_AXIS));
//
// inactiveJobsInnerPanel = new JPanel();
// inactiveJobsInnerPanel.setLayout(new BoxLayout(inactiveJobsInnerPanel,
// BoxLayout.Y_AXIS));
//
// inactiveScrollPane = new JScrollPane(inactiveJobsInnerPanel);
// inactiveScrollPane.setVerticalScrollBarPolicy(JScrollPane.VERTICAL_SCROLLBAR_ALWAYS);
...
//
// if ((xCoordinate.length() > 0) && (yCoordinate.length() > 0) && (direction !=
// -1)) {
// gridPanel.addRobot(Integer.parseInt(xCoordinate),
// Integer.parseInt(yCoordinate), direction);
// direction = -1;
...
// });
//
// addRobotCoordinatePanel.setLayout(new BoxLayout(addRobotCoordinatePanel,
// BoxLayout.X_AXIS));
...
// addRobotDirectionPanel.setLayout(new BoxLayout(addRobotDirectionPanel,
// BoxLayout.X_AXIS));
...
// * Active Job Panel Constructor
// */
// public JobPanel(String jobID, Float percentageComplete, JobTable
// jobDataStore) {
// setLayout(new BorderLayout());
// // setPreferredSize(new Dimension(100, 100));
//
...
// JPanel robotInnerPanel = new JPanel();
// JLabel robotNameLabel = new JLabel(r.getName());
// JLabel robotPositionLabel = new JLabel("Position: " + "(" + r.getX() + "," +
// r.getY() + ")");
// JLabel robotWeightLabel = new JLabel("Weight: " + r.getCurrentWeight() + "/"
// + r.getMaxWeight());
// robotInnerPanel.add(robotNameLabel, new BoxLayout(robotInnerPanel,
// BoxLayout.Y_AXIS));
// robotInnerPanel.add(robotPositionLabel, new BoxLayout(robotInnerPanel,
// BoxLayout.X_AXIS));
// robotInnerPanel.add(robotWeightLabel, new BoxLayout(robotInnerPanel,
// BoxLayout.X_AXIS));
// add(robotInnerPanel);
// }
// }
...
// for (Robot r : searchList) {
// newRobotTable.put(r.getName(), addRobot(r.getCurrentX(), r.getCurrentY(), 0,
// false));
// // r.getCurrentWeight();
// // r.getMaxWeight();
// }
