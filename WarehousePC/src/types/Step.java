...
public class Step {
	...
	/**
	 * @param command
	 *            the command (drop or an item name for pickup)
	 * @param coordinate
	 *            A type node containing coordinates to travel to in the plan
	 */
	...
	/**
	 * @param item
	 *            the item code of the item to fetch
	 * @param quantity
	 *            amount of items to pick up (may not be the same as task as robot
	 *            can have a full inventory)
	 * @param coordinate
	 *            coordinate A type node containing coordinates to travel to in the
	 *            plan
	 */
